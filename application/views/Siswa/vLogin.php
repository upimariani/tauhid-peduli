...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url('asset/AdminLTE/') ?>index2.html"><b>Login</b>Siswa</a>
        </div>
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?= base_url('Siswa/cAuthSiswa') ?>" method="post">
                ...
                <p class="mb-1">
                    <a href="<?= base_url('Siswa/cAuthSiswa/register') ?>">Anda Belum Memiliki Akun?</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>

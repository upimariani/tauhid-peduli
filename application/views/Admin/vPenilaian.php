                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                ?>
                                                    <a href="<?= base_url('Admin/cPenilaian/nilai_tes_tulis/' . $value->id_dt_siswa) ?>" class="btn btn-block btn-warning"><i class="fas fa-user-cog"></i></a>
                                                <?php
                                                } else {
                                                ?>
...
?>
    <div class="modal fade" id="tes_alquran<?= $value->id_dt_siswa ?>">
        <div class="modal-dialog">
            <form action="<?= base_url('Admin/cPenilaian/nilai_baca/' . $value->id_dt_siswa) ?>" method="POST">
...
?>
    <div class="modal fade" id="tes_wawancara<?= $value->id_dt_siswa ?>">
        <div class="modal-dialog">
            <form action="<?= base_url('Admin/cPenilaian/nilai_wawancara/' . $value->id_dt_siswa) ?>" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
